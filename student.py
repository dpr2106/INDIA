...
class studentClass:
    def __init__(self,root):
        ...
        title=Label(self.root,
                    ...
                    bg="light blue",
                    fg="black",).place(x=10,y=15,width=1180,height=35)
...
##########################
        ...
        self.btn_clear=Button(self.root,
                               text='CLEAR',        
                            font=("goudy old style",15,"bold"),
                            bg="#607d8b",
                            fg="white",
        ...
        btn_search=Button(self.root,
                            ...
                            fg="white",
                            cursor="hand2",
                            command=self.search).place(x=1070,
                                                  y=60,
                                                  width=120,
                                                  height=28)
        ...
        self.CourseTable.heading("name",text="Contact")    
        self.CourseTable.heading("email",text="Admission")
        self.CourseTable.heading("gender",text="Gender")
        self.CourseTable.heading("dob",text="DOB")
        self.CourseTable.heading("contact",text="Name")
        self.CourseTable.heading("admission",text="Email")
        ...
        self.CourseTable.column("address",width=2000)
